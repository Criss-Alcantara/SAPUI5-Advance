sap.ui.define([
    ...
    function _readSignature(orderId, employeeId) {
        ...
        this.getView().getModel("Inc_Model").read("/SignatureSet(OrderId='" + orderId
        ...
        this.byId("uploadCollection").bindAggregation("items", {
            ...
            template: new sap.m.UploadCollectionItem({
                documentId: "{Inc_Model>AttId}",
                visibleEdit: false,
                fileName: "{Inc_Model>FileName}"
    ...
    return Controller.extend("logaligroup.employees.controller.OrderDetails", {
        ...
        onSaveSignature: function (oEvent) {
            ...
            if (!signature.isFill()) {
                ...
                this.getView().getModel("Inc_Model").create("/SignatureSet", body, {
                    success: function () {
        ...
        onFileChange: function (oEvent) {
            ...
            let oCustomerHeaderToken = new sap.m.UploadCollectionParameter({
                name: "x-csrf-token",
                value: this.getView().getModel("Inc_Model").getSecurityToken()
            });
        ...
        onFileDeleted: function (oEvent) {
            ...
            var sPath = oEvent.getParameter("item").getBindingContext("Inc_Model").getPath();
            this.getView().getModel("Inc_Model").remove(sPath, {
                success: function () {
        ...
        downloadFile : function(oEvent) {
            const sPath = oEvent.getSource().getBindingContext("Inc_Model").getPath();
